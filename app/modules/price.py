...
def extract_price_from_image(image_bytes):
    """Extract text and price from invoice image using OCR or fallback"""
    ...
    # Fallback: Simulate OCR output for demo invoice
    # This matches the structure of our sample invoice
    return """GOVERNMENT INVOICE
Invoice No: INV-2025-001
Date: 04-Jan-2025

ITEM DESCRIPTION                AMOUNT

High-End Gaming Laptop         Rs. 1,50,000
